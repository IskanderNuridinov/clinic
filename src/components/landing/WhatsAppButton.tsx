...
export default function WhatsAppButton() {
  return (
    <Link
      ...
      className="wa-float fixed bottom-6 right-6 z-40 w-14 h-14 rounded-full flex items-center justify-center shadow-xl transition-transform duration-150 hover:scale-110 focus:outline-none focus:ring-4 focus:ring-[#25d366]/40"
